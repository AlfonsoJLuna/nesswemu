...
void Processor_CPU_Run()
{
	...
	Opcode00:	BRK();						CPU.Cycles += 7;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode01:	ORA(Indexed_Indirect());	CPU.Cycles += 6;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode02:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode03:	SLO(Indexed_Indirect());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode04:	NOP();						CPU.Cycles += 3;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode08:	PHP();						CPU.Cycles += 3;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode09:	ORA(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode0A:	ASL_Accumulator();        	CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode0B:	ANC(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode0C:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	...
	Opcode12:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode13:	SLO(Indirect_Indexed());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode14:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode18:	CLC();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode19:	ORA(Absolute_Y());			CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode1A:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode1B:	SLO(Absolute_Y());			CPU.Cycles += 7;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode1C:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	...
	Opcode22:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	Opcode28:	PLP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode29:	AND(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode2A:	ROL_Accumulator();        	CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	Opcode32:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode33:	RLA(Indirect_Indexed());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode34:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode38:	SEC();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode39:	AND(Absolute_Y());			CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode3A:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode3B:	RLA(Absolute_Y());			CPU.Cycles += 7;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode3C:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	...
	Opcode40:	RTI();						CPU.Cycles += 6;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode41:	EOR(Indexed_Indirect());	CPU.Cycles += 6;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode42:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode43:	SRE(Indexed_Indirect());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode44:	NOP();						CPU.Cycles += 3;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode48:	PHA();						CPU.Cycles += 3;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode49:	EOR(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode4A:	LSR_Accumulator();        	CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	Opcode52:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode53:	SRE(Indirect_Indexed());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode54:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode58:	CLI();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode59:	EOR(Absolute_Y());			CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode5A:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode5B:	SRE(Absolute_Y());			CPU.Cycles += 7;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode5C:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	...
	Opcode60:	RTS();						CPU.Cycles += 6;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode61:	ADC(Indexed_Indirect());	CPU.Cycles += 6;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode62:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode63:	RRA(Indexed_Indirect());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode64:	NOP();						CPU.Cycles += 3;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode68:	PLA();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode69:	ADC(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode6A:	ROR_Accumulator();        	CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	Opcode72:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode73:	RRA(Indirect_Indexed());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode74:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode78:	SEI();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode79:	ADC(Absolute_Y());			CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode7A:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode7B:	RRA(Absolute_Y());			CPU.Cycles += 7;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode7C:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	...
	Opcode80:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode81:	STA(Indexed_Indirect());	CPU.Cycles += 6;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode82:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	Opcode88:	DEY();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode89:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	Opcode8A:	TXA();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	Opcode92:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	Opcode98:	TYA();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	Opcode99:	STA(Absolute_Y());			CPU.Cycles += 5;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	Opcode9A:	TXS();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	OpcodeA8:	TAY();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeA9:	LDA(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	OpcodeAA:	TAX();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	OpcodeB2:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	OpcodeB8:	CLV();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeB9:	LDA(Absolute_Y());			CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	OpcodeBA:	TSX();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	OpcodeC2:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	OpcodeC8:	INY();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeC9:	CMP(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	OpcodeCA:	DEX();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	OpcodeD2:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeD3:	DCP(Indirect_Indexed());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	OpcodeD4:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	OpcodeD8:	CLD();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeD9:	CMP(Absolute_Y());			CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	OpcodeDA:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeDB:	DCP(Absolute_Y());			CPU.Cycles += 7;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	OpcodeDC:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	...
	OpcodeE2:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	OpcodeE8:	INX();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeE9:	SBC(Immediate());			CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	OpcodeEA:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	...
	OpcodeF2:	KIL();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeF3:	ISC(Indirect_Indexed());	CPU.Cycles += 8;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	OpcodeF4:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 2)];
	...
	OpcodeF8:	SED();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeF9:	SBC(Absolute_Y());			CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	OpcodeFA:	NOP();						CPU.Cycles += 2;	goto *Opcode[Memory_CPU_Read(CPU.PC += 1)];
	OpcodeFB:	ISC(Absolute_Y());			CPU.Cycles += 7;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
	OpcodeFC:	NOP();						CPU.Cycles += 4;	goto *Opcode[Memory_CPU_Read(CPU.PC += 3)];
